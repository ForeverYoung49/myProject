    ...
    <div class="container col-10" style="margin-top: 15px;">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="row" style="margin: 10px -5px;">
                    <a href="/adminPanel/showAddChapster" class="d-flex justify-content-start active col btn btn-dark text-light your-titels your-titels">Добавить главы манги</a>
                </div>
                <div class="row" style="margin: 10px -5px;">
            ...
            <div class="col-md-8 your-titels" style="margin:20px 0px; padding: 0px; font-size: 18px;">
                <form method="post" action="/adminPanel/addChapster" enctype="multipart/form-data">
                    @csrf
                    <div class="col" style="margin:20px 0px; padding: 0px;">
                        ...
                        <div class="row edit-profile d-flex justify-content-center">
                            ...
                            <div class="col-md-6 d-flex justify-content-left">
                                <input type="text" class="form-control" required name="tome">
                            </div>
                        </div>
                        <div class="row edit-profile d-flex justify-content-center">
                            <div class="col-md-2">
                        ...
                        <div class="row edit-profile d-flex justify-content-center">
                            <div class="col-md-2">
                                <label>Набор изображений:</label>
                            </div>
                            <div class="col-md-6 d-flex justify-content-left">
                                <input type="file" multiple required accept="image/*" name="chapster[]">
                            </div>
                        </div>
                        <div class="row edit-profile d-flex justify-content-center">
