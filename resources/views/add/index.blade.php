            ...
            <div class="row" style="margin-top: 20px;">
                <div class="col-md-8 col-lg-8">
                    ...
                    <div class="row text-light justify-content-center bg-dark style-last-manga">
                        <div class="col-5 col-sm-2 col-lg-2 col-xl-1 d-flex d-xl-flex justify-content-end justify-content-sm-center align-items-sm-center" style="padding: 0px;"><img class="rounded d-flex justify-content-end" src="assets/img/poster1.jpg" style="height: 90px;"></div>
                        <div class="col-5 col-sm-2 col-lg-2 col-xl-1 d-flex d-xl-flex align-items-center justify-content-sm-start justify-content-xl-center"
                            ...
                            <p class="d-xl-flex align-items-xl-center star"><i class="fa fa-star"></i>&nbsp;9.22</p>
                        </div>
                        <div class="col-sm-8 col-lg-6 col-xl-8 d-flex d-xl-flex justify-content-center align-items-center justify-content-sm-start align-items-xl-center">
                            <h4 style="margin: 0px;"><a class="text-light" href="#">Manga name</a></h4>
                        </div>
                ...
                <div class="col-md-4 col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-12 col-lg-12 item">
                            <div class="row">
                                <div class="col-md-12 col-lg-12 d-flex d-lg-flex justify-content-center align-items-center align-items-lg-center"><a href="#"><img class="img-fluid border rounded d-flex" src="assets/img/desk.jpg" style="width: 200px;"></a></div>
